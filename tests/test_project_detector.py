...
class TestProjectDetector:
    ...
    def test_find_idea_directory_not_found(self, temp_dir: Path) -> None:
        ...
        with pytest.raises(IdeaDirectoryNotFoundError, match="No .idea directory found"):
    ...
    def test_find_idea_directory_not_dir(self, temp_dir: Path) -> None:
        ...
        with pytest.raises(IdeaDirectoryNotFoundError, match=".idea exists but is not a directory"):
            ProjectDetector.find_idea_directory(temp_dir)
    ...
    def test_is_python_project_from_modules_xml(self, mock_idea_python_project: Path) -> None:
