...
class TestXMLUpdater:
    ...
    def test_update_misc_xml_new_file(self, temp_dir: Path, mock_interpreter_path: Path) -> None:
    ...
    def test_update_misc_xml_existing_file(self, mock_misc_xml: Path, mock_interpreter_path: Path) -> None:
    ...
    def test_update_misc_xml_with_backup(self, mock_misc_xml: Path, mock_interpreter_path: Path) -> None:
    ...
    def test_update_misc_xml_invalid_xml(self, temp_dir: Path, mock_interpreter_path: Path) -> None:
    ...
    def test_update_misc_xml_permission_error(self, temp_dir: Path, mock_interpreter_path: Path) -> None:
    ...
    def test_preserve_existing_components(self, temp_dir: Path, mock_interpreter_path: Path) -> None:
