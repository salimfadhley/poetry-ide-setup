...
class TestSetupIdeConfiguration:
    ...
    def test_setup_ide_configuration_success(
        ...
        mock_poetry_detector.get_environment_info.return_value = (
        ...
        mock_project_detector.get_misc_xml_path.return_value = (
    ...
    def test_setup_ide_configuration_no_idea_directory(
        ...
        mock_project_detector.find_idea_directory.side_effect = (
    ...
    def test_setup_ide_configuration_dry_run(
        ...
        result = setup_ide_configuration(
            project_path=mock_idea_python_project, dry_run=True
        )
    ...
    def test_setup_ide_configuration_force_update(
        ...
        result = setup_ide_configuration(
            project_path=mock_idea_python_project, force=True
        )
    ...
    def test_setup_ide_configuration_verbose_output(
        ...
        verbose_calls = [
            call for call in mock_console.print.call_args_list if "[dim]" in str(call)
        ]
